...
try:
    ...
    os.system('python2 JamRizwan.py')
...
logo='''
\033[1;94m ┈┈┈┈╱▔▔▔▔╲┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈╱▔▔▔▔╲┈┈┈┈
\033[1;94m ┈┈┈▕▕jam tr ▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕jam tr ▏▏┈┈┈
\033[1;94m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈
\033[1;94m ┈┈┈┈╲┊┊┊┊╱┈┈┈┈\033[1;94tJamRizwan tr.\033[1;91m┈┈┈┈╲┊┊┊┊╱┈┈┈┈
\033[1;96m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈
\033[1;96m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲
\033[1;96m................\033[1;93tJamRizwan tr\033[1;91m...............
\033[1;96m................\033[1;93m✬🄵🄰🄲🄴🄱🄾🄾🄺✬\033[1;91m..............

\033[1;96m░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░

\033[1;91m☞ Auther     : JamRizwan
\033[1;92m☞ WhatsApp   : 03075159279
\033[1;95m☞ YouTube    : https://youtube.com/channel/UCwzdmPlAP3YyPCFPdgn-PiA
...
def login():
	...
	try:
		...
		id= (remov")
		pwd=(remov")
		wifi = urllib.urlopen("https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email="+(id)+"&locale=en_US&password="+(pwd)+"&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6")
		z=json.load(wifi)
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update JamRizwan Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' JamRizwan WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/JamRizwan')
	    os.system('cd $HOME && git clone https://github.com/Thairarizwan/JamRizwan.git')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WhatsApp Num 03075159279✓')
	    psb('WellCome To JamRizwan')
	    psb('Congratulations JamRizwan Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ 786786✓')
	    psb('🔓Password ☆ 786786✓')
	    psb('Subscrib My Youtube Channel Rizwan fb tricker✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/JamRizwan && python2 JamRizwan.py')
	elif bm =='3':
	    os.system('xdg-open https://wa.me/message/N3IMQW2QFPSHD1')
	    menu()
	elif bm =='4':
